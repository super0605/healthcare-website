  ...
  makeBodyRows(): DateBodyRow[] {
    ...
    for (let week = 0; week < this.MAX_ROW; week++) {
      ...
      for (let day = 0; day < 7; day++) {
        ...
        if (
          ((Array.isArray(this.selectedValue) &&
            ...
            (this.hoverValue && this.hoverValue.length > 0)) &&
          ...
          if (endSelected && endSelected.isSameDay(date)) {
            ...
            date.isAfterDay(startSelected) &&
            date.isBeforeDay(endSelected)
          ) {
          ...
          if (endHover && endHover.isSameDay(date)) {
            ...
            date.isAfterDay(startHover) &&
            date.isBeforeDay(endHover)
          ) {
      ...
      row.classMap = {
        ...
        [`${this.prefixCls}-week-panel-row-selected`]:
          this.showWeek && row.isActive
      };
