...
import { MpCalendarI18nInterface } from '../i18n';
import {
  DisabledDateFn,
  PanelMode,
  SupportTimeOptions
    ...
    <div [class.ant-picker-datetime-panel]="showTimePicker">
      ...
      <ng-container *ngIf="showTimePicker && timeOptions">
        <mp-time-picker-panel
          ...
          [format]="timeOptions.mpFormat"
          [mpHourStep]="timeOptions.mpHourStep"
          [mpMinuteStep]="timeOptions.mpMinuteStep"
          [mpSecondStep]="timeOptions.mpSecondStep"
          [mpDisabledHours]="timeOptions.mpDisabledHours"
          [mpDisabledMinutes]="timeOptions.mpDisabledMinutes"
          [mpDisabledSeconds]="timeOptions.mpDisabledSeconds"
          [mpHideDisabledOptions]="timeOptions.mpHideDisabledOptions"
          [mpDefaultOpenValue]="timeOptions.mpDefaultOpenValue"
          [mpUse12Hours]="timeOptions.mpUse12Hours"
          [mpAddOn]="timeOptions.mpAddOn"
          [opened]="true"
        ></mp-time-picker-panel>
...
export class InnerPopupComponent implements OnChanges {
  ...
  @Input() locale: MpCalendarI18nInterface;
  ...
  onSelectDate(date: CandyDate | Date): void {
    ...
    const timeValue = this.timeOptions && this.timeOptions.mpDefaultOpenValue;
