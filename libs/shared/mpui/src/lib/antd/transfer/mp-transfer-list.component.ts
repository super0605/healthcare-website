...
@Component({
  selector: 'mp-transfer-list',
  exportAs: 'mpTransferList',
  preserveWhitespaces: false,
  templateUrl: './mp-transfer-list.component.html',
...
export class MpTransferListComponent {
  // #region fields
  ...
  // events
  @Output() readonly handleSelectAll: EventEmitter<boolean> = new EventEmitter<
    boolean
  >();
  @Output() readonly handleSelect: EventEmitter<
    TransferItem
  > = new EventEmitter();
