...
@Component({
  selector: 'li[mp-pagination-item]',
      ...
      <ng-container [ngSwitch]="type">
        ...
        <ng-container *ngSwitchDefault>
          <a class="ant-pagination-item-link" [ngSwitch]="type">
            <i mp-icon mpType="left" *ngSwitchCase="'prev'"></i>
            <i mp-icon mpType="right" *ngSwitchCase="'next'"></i>
...
export class MpPaginationItemComponent implements OnChanges {
  @Input() active = false;
