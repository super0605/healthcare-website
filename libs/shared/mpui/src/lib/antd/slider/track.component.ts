...
export interface MpSliderTrackStyle {
  bottom?: string | null;
  height?: string | null;
  left?: string | null;
  width?: string | null;
...
@Component({
  ...
  selector: 'mp-slider-track',
  exportAs: 'mpSliderTrack',
  preserveWhitespaces: false,
  template: `
    <div class="ant-slider-track" [ngStyle]="style"></div>
  `
})
export class MpSliderTrackComponent implements OnChanges {
