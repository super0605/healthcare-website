...
export const NZ_MENTION_TRIGGER_ACCESSOR: ExistingProvider = {
  ...
  useExisting: forwardRef(() => MpMentionTriggerDirective),
  multi: true
};

@Directive({
  selector: 'input[mpMentionTrigger], textarea[mpMentionTrigger]',
  exportAs: 'mpMentionTrigger',
...
export class MpMentionTriggerDirective
  ...
  ngAfterViewInit(): void {
    this.mpMentionService.registerTrigger(this);
  }
