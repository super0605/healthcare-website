...
import { MpSafeAny } from 'ng-zorro-antd';
import { isTouchEvent } from '../core/util';
...
@Injectable()
export class MpResizableService implements OnDestroy {
  ...
  handleMouseDown$ = new Subject<MpResizeHandleMouseDownEvent>();
  ...
  constructor(private ngZone: NgZone, @Inject(DOCUMENT) document: MpSafeAny) {
