  ...
  template: `
    ...
    <ng-container *ngIf="!treeTemplate">
      ...
      >
        ...
        >
          <i mp-icon *ngIf="icon" [mpType]="icon"></i>
        </span>
      </span>
      <span
        class="ant-tree-title"
        [innerHTML]="title | mpHighlight: matchedValue:'i':'font-highlight'"
      >
      </span>
    </ng-container>
  `,
...
export class MpTreeNodeTitleComponent {
