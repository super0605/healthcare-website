...
import {
  FromToInterface,
  MpCarouselComponentAsSource,
  PointerVector
} from '../typings';

export abstract class MpCarouselBaseStrategy {
  // Properties that strategies may want to use.
  protected carouselComponent: MpCarouselComponentAsSource | null;
  protected contents: MpCarouselContentDirective[];
  ...
  constructor(
    carouselComponent: MpCarouselComponentAsSource,
